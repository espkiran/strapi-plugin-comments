      ...
      <Wrapper>
        {!blockedThread && (
          <CheckPermissions permissions={pluginPermissions.moderateComments}>
            <Button
              ...
              icon={
                <FontAwesomeIcon icon={blocked ? faComment : faCommentSlash} />
              }
              label={formatMessage({
                id: `${pluginId}.list.item.moderation.button.comment.${
                  blocked ? "restore" : "hide"
                }`,
              })}
            />
          </CheckPermissions>
        ...
        <CheckPermissions permissions={pluginPermissions.moderateThreads}>
          <Button
            ...
            label={formatMessage({
              id: `${pluginId}.list.item.moderation.button.thread.${
                blockedThread ? "restore" : "hide"
              }`,
            })}
          />
        </CheckPermissions>
