      ...
      {isBlocked && (
        <CheckPermissions permissions={pluginPermissions.moderate}>
          <CardHeaderBlocked>
            ...
            <FormattedMessage
              id={`${pluginId}.list.item.header.blocked${
          ...
          {isAbuseReported && (
            <CheckPermissions permissions={pluginPermissions.moderateReports}>
              <CardHeaderReports href="#abuse-reports" onClick={onReportsClick}>
                ...
                <FormattedMessage
                  id={`${pluginId}.list.item.header.abuse`}
                  values={{ count: abuseReports.length }}
                />
              </CardHeaderReports>
            </CheckPermissions>
          )}
        ...
        <CardHeaderIndicatorsContainer>
          {isNew && (
            <CardHeaderIndicatorBlue
              title={formatMessage({
                id: `${pluginId}.list.item.indication.new`,
              })}
            >
          ...
          <CheckPermissions permissions={pluginPermissions.moderateReports}>
            {isAbuseReported && (
              <CardHeaderIndicatorRed
                title={formatMessage({
                  id: `${pluginId}.list.item.indication.abuse`,
                })}
              >
                <FontAwesomeIcon icon={faFire} />
              </CardHeaderIndicatorRed>
